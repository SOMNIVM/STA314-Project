...
train_data_cleaned = train_data.drop(columns=['PatientID', 'DoctorInCharge'], errors='ignore')
...
correlations = train_data.corr(numeric_only=True)['Diagnosis'][:-1].sort_values()
